...
public class BuildDB
  ...
  public static void main (String[] args) throws Exception {
    ...
    FileOutputStream fos = new FileOutputStream("src/main/java/kevinboone/suntimes/City.java");
    PrintStream ps = new PrintStream (fos);
    FileInputStream fis = new FileInputStream("/usr/share/zoneinfo/zone.tab");
    InputStreamReader isr = new InputStreamReader (fis);
    BufferedReader br = new BufferedReader (isr);

    ps.println ("// Do not edit this file by hand");
    ps.println ("package kevinboone.suntimes;");
    ps.println ("public class City {");
    ps.println ("  public double lat, longt; public String name; public String code;");
